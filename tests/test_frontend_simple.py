...
class FrontendTester:
    ...
    def test_health_components(self) -> bool:
        ...
        try:
            response = requests.get(
                f"{BACKEND_URL}/health/components", params={"windowMinutes": 60}, timeout=5
            )
            assert response.status_code == 200
            data = response.json()
            ...
            self.test_results.append(
                ("GET /health/components", True, "Health components endpoint working")
            )
            return True
        except Exception as e:
    ...
    def test_create_artifact(self) -> bool:
        ...
        try:
            artifact_data = {"url": "https://example.com/test-artifact-v2"}
            response = requests.post(
    ...
    def test_get_artifact(self) -> bool:
        ...
        try:
            ...
            print(f"   download_url: {artifact['data']['download_url']}")
            self.test_results.append(
                ("GET /artifacts/{type}/{id}", True, f"Retrieved artifact {artifact_id}")
            )
            return True
        except Exception as e:
    ...
    def test_search_by_name(self) -> bool:
        ...
        try:
            response = requests.get(
                f"{BACKEND_URL}/artifact/byName/test", headers=self.get_headers(), timeout=10
            )
            ...
            self.test_results.append(
                ("GET /artifact/byName/{name}", True, "Search by name working")
            )
            return True
        except Exception as e:
            print(f"❌ GET /artifact/byName/test failed: {e}")
    ...
    def test_reset_endpoint(self) -> bool:
        ...
        try:
            response = requests.delete(
                f"{BACKEND_URL}/reset", headers=self.get_headers(), timeout=10
            )
            assert response.status_code == 200
